    ...
    <Router>
      <div className="container mt-4">
        <nav className="navbar navbar-expand-lg mb-4 rounded">
          <div className="navbar-brand App-logo-left">
            <img src={logo} className="App-logo" alt="OctoFit Logo" />
            <Link to="/" style={{ textDecoration: 'none', color: 'inherit' }}>OctoFit Tracker</Link>
          </div>
          ...
          <Route path="/" element={
            <div className="card text-center">
              <div className="card-body">
                <h1 className="card-title display-4 mb-3">Welcome to <span>OctoFit Tracker!</span></h1>
